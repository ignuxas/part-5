        ...
        <div v-if="Object.keys(getEmployee).length">
            ...
            <div class="flex px-20 py-6 w-[100%] text-lg bg-white rounded shadow">
                <div class="w-[50%]">
                    ...
                    <p v-if="getEmployee.phone_number" class="p-6">Telefono numeris: <a class="text-primary" href="" @click.prevent="">{{ getEmployee.phone_number }}</a></p>
                </div>
                <div>
                    ...
                    <p v-if="getEmployee.expand.department_id" class="p-6">Departamentas: 
